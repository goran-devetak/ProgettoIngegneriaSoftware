    ...
    import DeleteButton from "@/app/components/station/DeleteButton";
            ...
            <div className="flex justify-center items-center">
                <div className="flex flex-col items-center justify-center text-center bg-white rounded-lg shadow-lg p-8 w-fit">
                    ...
                    <div className="flex items-center">
                        ...
                        <p className={"font-bold text-2xl " + (station.isActive ? "text-mygreen" : "text-myred")}>
                            [{station.isActive ? "Attiva" : "Non attiva"}]
                        </p>
                    </div>
                    {!isFormHidden && <StationForm station={station} />}
                    <div className="flex flex-col items-center justify-center">
                        <button
                            className="font-bold py-2 px-4 rounded bg-blue-500 text-white"
                            onClick={() => setIsFormHidden(!isFormHidden)}
                        >
                            {isFormHidden ? "Assegna posti" : "Nascondi modulo"}
                        </button>
                        <div className="flex space-x-7 my-5">
                            <StationActivenessButton 
